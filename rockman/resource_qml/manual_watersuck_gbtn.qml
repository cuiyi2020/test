    ...
    RowLayout{
        ...
        Button {
            ...
            Text {
                ...
                text: "升起"
                font.pixelSize: 20
                color: (manual.watersuck_state==1) ? "FF232F43" : "white"
            }
            checked: true;
            background: Rectangle{
                ...
                Rectangle {
                    ...
                    color: (manual.watersuck_state==1) ? "white" : "transparent"
                }
                color: (manual.watersuck_state==1) ? "white" : "transparent"
            }
            onClicked: {
        ...
        Button {
            ...
            Text {
                ...
                text: qsTr("放下")
                font.pixelSize: 20
                color: (manual.watersuck_state==1) ? "white" : "FF232F43"
            }
            background: Rectangle{
                id:right_bg
                width: parent.width
                ...
                Rectangle {
                    ...
                    width: 25;
                    height: parent.height;
                    color: (manual.watersuck_state==1) ? "transparent" : "white"
                }
                color: (manual.watersuck_state==1) ? "transparent" : "white"
            }
            onClicked: {
