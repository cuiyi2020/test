...
#include "../rockman/task_report/dataobject.h"
...
QT_MOC_LITERAL(4, 37, 13), // "numberChanged"
QT_MOC_LITERAL(5, 51, 4), // "name"
QT_MOC_LITERAL(6, 56, 5), // "color"
QT_MOC_LITERAL(7, 62, 6) // "number"

    },
    "DataObject\0nameChanged\0\0colorChanged\0"
    "numberChanged\0name\0color\0number"
};
...
void DataObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DataObject::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataObject::numberChanged)) {
                *result = 2;
                return;
            }
        }
        ...
        case 2: *reinterpret_cast< QString*>(_v) = _t->number(); break;
        default: break;
        }
